...
<head>
    ...
    <title>Flight Confirmation · Klar Travels</title>
    <style>
        /* Base & reset */
        * {
        ...
        /* tables general */
        .info-table, .flight-table, .passenger-table, .seat-table, .fare-table {
            width: 100%;
        ...
        .info-table td, .flight-table td, .passenger-table td, .seat-table td, .fare-table td {
            padding: 8px 10px;
        ...
        .passenger-table .header-row, .seat-table .header-row, .fare-table .header-row {
            background: #f5f5f5;
            font-weight: bold;
            text-align: center;
        }
        ...
        @media only screen and (max-width: 640px) {
            ...
            .info-table tbody, .flight-table tbody, .passenger-table tbody, .seat-table tbody, .fare-table tbody {
                display: block;
                width: 100%;
            }
            .info-table tr, .flight-table tr, .passenger-table tr, .seat-table tr, .fare-table tr {
                display: block;
                width: 100%;
                margin-bottom: 6px;
                border: 1px solid #000;
        ...
        @media only screen and (max-width: 420px) {
            ...
            .passenger-table td, .seat-table td, .fare-table td {
...
<div class="container">
    ...
    <table class="fare-table">
        <tr class="header-row">
            <td style="text-align: left; width: 30%;">Passenger Name</td>
            <td style="width: 17%;">Baggage</td>
            <td style="width: 17%;">Meals</td>
            <td style="width: 18%;">Seat</td>
            <td style="width: 18%;">Total Price</td>
        </tr>
