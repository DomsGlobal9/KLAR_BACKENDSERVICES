...
<head>
    ...
    <title>Flight Booking Confirmation - Agency Copy</title>
    <style>
        body {
...
<body>
    <div class="container">
        ...
        <div class="section">
            ...
            <div class="price-grid">
                <div class="price-card">
                    ...
                    <div class="value">{{formatPrice tripjackPrice}}</div>
                </div>
                <div class="price-card">
                    <div class="label">Markup</div>
                    <div class="value">{{formatPrice markupPrice}}</div>
                </div>
                <div class="price-card">
        ...
        <!-- Agency Notes -->
        <div class="section agency-notes">
