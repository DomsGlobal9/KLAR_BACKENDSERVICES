...
async function run() {
    ...
    try {
                ...
                RoomSelection: [
                    {
                        ...
                        NumberOfAdults: 2,
                        NumberOfChild: 0,
                        RoomSelectionKey: "20260530|20260531|W|71|6852|DBL.ST|HBG-SELECT|RO||1~2~0||N@07~~24980~848655279~N~~~NOR~~42C2DBB552354B5178012625189705AAUS0001000000000524980",
                        RoomRate: 12806.7,
                        BoardName: "ROOM ONLY",
                        Guest: [
                            {
        ...
        const res = await rateGainClient.post("/api/SmartDistribution/PreCheckReservation", payload);
