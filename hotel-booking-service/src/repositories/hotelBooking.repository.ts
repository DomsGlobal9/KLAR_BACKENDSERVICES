import { BookingModel, BookingStatus, IBooking, BookingProvider } from "../models/Booking.model";
...
export class HotelBookingRepository {
     ...
     */
    async find(query: FilterQuery<IBooking>, sort?: any, skip?: number, limit?: number, lean = false): Promise<any[]> {
     ...
     */
    async findByIdAndUpdate(id: string, update: UpdateQuery<IBooking>, options?: any): Promise<IBooking | null> {
     ...
     * Find one and update
     */
    async findOneAndUpdate(query: FilterQuery<IBooking>, update: UpdateQuery<IBooking>, options?: any): Promise<IBooking | null> {
     ...
     */
    async deleteExpiredBookings(statuses: BookingStatus[], beforeDate: Date): Promise<number> {
