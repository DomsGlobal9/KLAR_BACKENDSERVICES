...
class InvoicePdfService {
    /**
     * Converts a local asset file directly into a base64 Data URI for Puppeteer rendering
     */
    private getLogoAsBase64(): string {
        try {
            // Your asset directory path assignment profile
            const logoPath = "D:\\Doms_Global_Projects\\klar_b2b\\KLAR_BACKENDSERVICES\\cabs-service\\src\\assets\\logo.png";
